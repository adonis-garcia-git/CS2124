...
public:
    ...
    virtual ~Pet() {} // Don't worry till later

protected:
    const string& getName() const { return name; }
private: // ALL fields should be private
    string name;
};
...
public:
	...
	this->Pet::eat(); // qualified because otherwise would be recursive;
    }
...
public:
    //Slug(const string& name) {} // What happens?
};
...
void someFunc(Pet& aPet) {
    cout << "someFunc: ";
    aPet.eat();
    // cout << aPet.getName() << endl; //doesn't have access
}
